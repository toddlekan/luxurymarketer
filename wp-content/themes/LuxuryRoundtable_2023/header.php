...
<head>
  ...
  <script src="<?= ld16_cdn($url_root) ?>/js/ld.js?<?= time() ?>"></script>
  ...
  <div class="navbar navbar-default navbar-fixed-top">
    ...
    <div class="container">
      <div class="navbar-header">
        ...
        <a href="/" class="initials"><img src="<?= $url_root ?>/img/lr_initials.png" /></a>
        <a href="/" id="logo-mobile"><img src="<?= $url_root ?>/img/LuxuryRoundtable.png" /></a>
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                ...
                <li><a class="reverse join" href="<?php
                                                  echo ($isMobileApp ? 'https://join.luxuryroundtable.com/LXR/?f=paid' : 'https://join.luxuryroundtable.com/LXR/?f=paid'); ?>">Join</a></li>
              </ul>
            </li>
          </ul>
        </div>
        ...
        <a href="/rss-feeds" class="rss"><img src="<?= $url_root ?>/img/rss-1-20.png" /></a>
      ...
      <div class="navbar-collapse collapse" id="navbar-main">
        ...
        <ul class="nav navbar-nav navbar-right">
          <li class="tagline make-us">
            <span class="lighter-grey">VOICE OF LUXURY</span>
          </li>
          <li class="make-us">
            <a href="https://join.luxuryroundtable.com/LXR/?f=paid" target="_blank" class="lighter-grey">BECOME A MEMBER</a>
          </li>
          <li class="label subscribe make-us">
            <a class="my" href="/log-in" target="_blank" style="display: none;">My Account</a>
            <span style="color: #ccc;" class="acc-divider"> &nbsp;|&nbsp; </span>
            <a class="sign-in loggedout pop-login lighter-grey" href="/log-in">LOG IN/MY ACCOUNT</a>
          ...
          <li class="label subscribe">
            ...
            <a class="sign-in-subscribe loggedout pop-subscribe" href="<?php echo ($isMobileApp ? '#' :
                                                                          '/subscription-form'); ?>" style="display: none;">
              Subscribe Now</a>
          </li> -->
        ...
        <ul class="nav navbar-nav navbar-center">
          <li>
            <span class="make-us lighter-grey text-center">VOICE OF LUXURY</span>
          </li>
        </ul>
  ...
  <div class="navbar fold subscribe">
    <div class="subscribe-inner">
      ...
      <ul class="clr">
        ...
        <li><a href="#" class="footer-subscribe"><img src="<?= $url_root ?>/img/subscribe.png"></a></li>
      </ul>
    </div>
  </div>
          ...
          <center>
            ...
            ?>
              <div class="pdf-header">
                <img src="<?= $url_root ?>/img/LuxuryRoundtable.png" style="width: 630px;" /></a>
            ...
            <a href="/" id="logo"><img src="<?= $url_root ?>/img/LuxuryRoundtable.png" style="width: 630px;" /></a>

            <center>
              <div class="navbar collapse navbar-collapse" style="width: 100%">
                <ul class="nav navbar-nav" style="float: none; margin: 0 auto; width: auto; gap:1rem; display:flex; justify-content: center;">
                  <li><a href="/" class="grey">Home</a></li>

                  <li><a href="/about" class="grey">About</a></li>

                  <li class="dropdown"> <a href="/category/networking-and-events" class="dropdown-toggle grey" data-toggle="dropdown" role="button" aria-expanded="false">Networking & Events<span class="caret"></span></a>
                  ...
                  <li class="dropdown"> <a href="/category/research" class="dropdown-toggle grey" data-toggle="dropdown" role="button" aria-expanded="false">Research<span class="caret"></span></a>
                  ...
                  <li class="dropdown"> <a href="/category/news" class="dropdown-toggle grey" data-toggle="dropdown" role="button" aria-expanded="false">
                  ...
                  <li class="dropdown"> <a href="#" class="dropdown-toggle grey" data-toggle="dropdown" role="button" aria-expanded="false">
                  ...
                  <li class="dropdown"> <a href="/category/luxury-class" class="dropdown-toggle grey" data-toggle="dropdown" role="button" aria-expanded="false">
                  ...
                  <li><a href="/partners" class="grey">Partners</a></li>
                  <li>
                    <a href="<?php
                        ...
                        <ul class="clr">
                          ...
                          <li>
                            <a href="#" class="header-magnify">
                              <img width="16" src="https://luxuryroundtable.com/wp-content/themes/LuxuryRoundtable_2023/img/magnify-new.png"></a>
                          </li>
                        </ul>
                      </div>
                    </form>
            ...
            <!-- div class="subscribe-box">
                <span>Become a more authoritative, connected and informed luxury professional – <a href="#">join Luxury Roundtable now</a> and access your benefits</span>
            </div -->
