...
<head id="theHead">
	...
	<link href="/wp-content/themes/LuxuryRoundtable_2023/css/general.css" type="text/css" rel="stylesheet" />
	...
	<script src="/wp-content/themes/LuxuryRoundtable_2023/js/jquery.js" type="text/javascript"></script>
...
<body id="thebody" class="body">
	...
	<header>
		<div class="header">
			<a href="https://www.luxuryroundtable.com/">
				<img id="logo-image" alt="Home" src="https://www.luxuryroundtable.com/wp-content/themes/LuxuryRoundtable_2023/img/LuxuryRoundtable.png" border="0" style="width: 700px;" />
			</a>
		</div>
	</header>

	<form style="display: none;" action="https://luxuryroundtable.us12.list-manage.com/subscribe?u=562830d59472392acd3d9f25a&id=e40241a98c" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" novalidate>
				...
				<td>
					<div id="thePanel">
						...
						<div id="newsletter_blurb_1" class="module_blurb">
							<h1>Subscribe to Luxury Roundtable newsletters for free
							</h1>
							<p>
							</p>
						</div>
				...
				<td>
					<div id="thePanel">
						...
						<div id="news_confirm_blurb_1" class="module_blurb">
							<p>Thank you for subscribing to the complimentary <i>Luxury Roundtable</i> newsletter. You should receive your first newsletter within a few days.
							</p>
						</div>
						<div id="news_confirm_blurb_3" class="module_blurb">
							<p><a href="https://www.luxuryroundtable.com">Return to the Luxury Roundtable homepage</a>.
							</p>
						</div>
					</div>
				</td>
		...
		<table>
			<tr>
				<td>
					...
					<span class="mr_social_sharing"> <a href="https://www.instagram.com/luxuryroundtable/" class="mr_social_sharing_popup_link" rel="nofollow"> <img src="<?= $url_root ?>/img/sharing/instagram.jpg" class="nopin" alt="Share on Instagram" title="Share on Instagram"> </a> </span>

					&nbsp;
					<span class="mr_social_sharing">
						<a target="_blank" href="http://www.linkedin.com/shareArticle?mini=true&amp;url=http%3A%2F%2Fwww.luxuryroundtable.com" class="mr_social_sharing_popup_link" rel="nofollow">
							<img src="/wp-content/themes/LuxuryRoundtable_2023/img/sharing/linkedin.png" class="nopin" alt="Share on LinkedIn" title="Share on LinkedIn"> </a>
					</span>
	...
	<footer>
		<div><i>Luxury Roundtable</i> </div>

		<div>
			<a href="mailto:news@napean.com?subject=Luxury Roundtable Customer Service">news@napean.com</a>
			<br />
			© Napean LLC. All rights reserved.<br />
			Luxury Roundtable is published each business day. Thank you for reading us.
		</div>
	</footer>
