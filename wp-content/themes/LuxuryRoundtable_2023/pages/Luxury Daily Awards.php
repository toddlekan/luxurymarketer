<?php
/*
Template Name: Luxury Daily Awards
*/
		...
		<div class="col-lg-8">
			...
			<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
				...
				<div class="entry-content">
					...
					$query = "SELECT p.ID, p.post_title, p.post_name, p.post_date
					FROM wp_posts AS p
					...
					WHERE t.name like 'luxury daily awards%' AND p.post_type LIKE 'post'
					GROUP BY p.id
			    ...
			    foreach( $results as $result ) {
					...
					<div class="navigation clearfix">
						...
						<div class="previousnav">
							<a href="/luxury-daily-awards/<?=$prev?>" rel="prev">« Previous archives</a>

						</div>
						<div class="nextnav">

							<?php if($next){?>
								<a href="/luxury-daily-awards/<?=$next?>" rel="next">Next archives »</a>
							<?php } ?>
