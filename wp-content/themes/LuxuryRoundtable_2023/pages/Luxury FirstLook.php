<?php
/*
Template Name: Luxury FirstLook
*/
		...
		<div class="col-lg-8">
			...
			<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
				...
				<div class="entry-content">
					...
					WHERE t.name like 'Luxury FirstLook%' AND p.post_type LIKE 'post'
					GROUP BY p.id
			    ...
			    foreach( $results as $result ) {
					...
					<div class="navigation clearfix">
						...
						<div class="previousnav">
							<a href="/luxury-firstlook/<?=$prev?>" rel="prev">« Previous archives</a>

						</div>
						<div class="nextnav">

							<?php if($next){?>
								<a href="/luxury-firstlook/<?=$next?>" rel="next">Next archives »</a>
							<?php } ?>
