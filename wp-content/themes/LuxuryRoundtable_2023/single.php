				...
				<div class="col-lg-6">
					...
					<p class="caption main">
						<font color="gray">
							...
							$content = str_replace('src="https://www.luxuryroundtable.com', 'src="https://www.luxuryroundtable.com', $content);
						...
						?>
								<div class="row call-to-action" style="display:block;">
									...
									<div class="col-lg-12">
										...
										<center>
											This content is accessible only to members of Luxury Roundtable. We would love for you to become a member and enjoy the many benefits soon after. <a href="https://join.luxuryroundtable.com/LXR/?f=paid" target="_blank">Please click here to enroll as a member of Luxury Roundtable.</a> Already a member?
					...
					<ul class="tools clr smallest bottom">
						...
						<li class="social inTool">
							<span class="mr_social_sharing"> <a alt="Tweet" href="https://www.instagram.com/luxuryroundtable" class="mr_social_sharing_popup_link" rel="nofollow"></a> </span>
						</li>
			...
			<div class="col-lg-8 related">
				...
				<div class="col-lg-12">
					...
					while (have_posts()) : the_post();
						...
						get_template_part('template-parts/content', 'related-item');
