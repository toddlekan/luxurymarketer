$(document).ready(function () {
  // Hide fullPage.js watermark immediately and continuously
  function hideWatermark() {
    $(".fp-watermark").hide().css("display", "none !important");
    $("a[href*='fullpage.js']").parent().hide();
  }
  
  // Hide immediately
  hideWatermark();
  
  // Hide after window loads
