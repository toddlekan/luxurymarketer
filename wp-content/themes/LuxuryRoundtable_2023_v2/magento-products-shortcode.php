...
if(count($_POST)){
	...
	if(!$response){
		...
		if(array_key_exists('product', $_POST) && $_POST['product'] == 'job'){
			...
			$a_event_from_email = "Luxury Roundtable";

			$message = <<<EOT

<p>Luxury Roundtable Job Posting
<p>
<p>Billing Info:
...
EOT;
	...
	if ($dir_url === 'https://luxuryroundtable.com/wp-content/themes/LuxuryRoundtable_2023_v2'){

			$dir_url = 'https://www.luxuryroundtable.com/wp-content/themes/LuxuryRoundtable_2023_v2';
	}
