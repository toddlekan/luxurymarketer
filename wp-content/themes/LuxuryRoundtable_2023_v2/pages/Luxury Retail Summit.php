<?php
/*
Template Name: Luxury Retail Summit
*/
		...
		<div class="col-lg-8">
			...
			<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
				...
				<div class="entry-content">
					...
					WHERE t.name like 'Luxury Retail Summit%' AND p.post_type LIKE 'post'
					GROUP BY p.id
			    ...
			    foreach( $results as $result ) {
					...
					<div class="navigation clearfix">
						...
						<div class="previousnav">
							<a href="/luxury-retail-summit/<?=$prev?>" rel="prev">« Previous archives</a>

						</div>
						<div class="nextnav">

							<?php if($next){?>
								<a href="/luxury-retail-summit/<?=$next?>" rel="next">Next archives »</a>
							<?php } ?>
