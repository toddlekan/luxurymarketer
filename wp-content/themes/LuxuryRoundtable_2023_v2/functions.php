...
function am19_url_change($url)
{
	...
	return $url; //str_replace('luxuryroundtable.com', 'www.luxuryroundtable.com', $url);
}
...
function ld16_gen_pdf($id = 0)
{
	...
	$wget_cmd = "/usr/bin/wget -O /tmp/lr/$id.html 'https://luxuryroundtable.com/?p=$id&format=pdf'";
	shell_exec($wget_cmd);
...
function ld16_get_post_meta($id, $name, $last_arg)
{
	...
	// $val = str_replace('http://www.luxuryroundtable.com', $server_name, $val);
	// if($name == 'Image'){
	// 	$val = str_replace('www.luxuryroundtable.com', 'cache.luxuryroundtable.com', $val);
...
function ld16_logged_in()
{
	...
	$logged_in = $_COOKIE['_QAS3247adjl'];
...
function ld16_permalink($id = 0)
{
	...
	return "https://www.luxuryroundtable.com/" . $slug . "/";
}
...
function ld16_cdn($input)
{
	...
	// 	$output = str_replace('luxuryroundtable.com', 'luxuryroundtable', $output);
	// 	$output = str_replace('luxuryroundtable', 'www.luxuryroundtable', $output);
	// }
	return $output;
}
...
function ld16_pdf($id = 0)
{
	...
	$url = 'https://www.luxuryroundtable.com/wp-content/uploads/pdf_cache' . $filename;
...
function ld16_cat_id($id = 0)
{
	...
	return str_replace('https://www.luxuryroundtable.com', 'https://luxuryroundtable.com', $category_id);
}
	...
	try {
		...
		if (!array_key_exists('message', $error)) {
			if (not_spamming()) {
				...
				$mail = new PHPMailer();
				$mail->From     = "editor@luxuryroundtable.com";
